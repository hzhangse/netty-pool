...
public class NettyHttpChannelPoolHandler extends SimpleChannelInboundHandler<HttpObject> {
    private static final Logger logger = Logger.getLogger(NettyHttpChannelPoolHandler.class.getName());
     ...
     * @param channelPool
     */
    public NettyHttpChannelPoolHandler(NettyChannelPool channelPool) {
        super();
